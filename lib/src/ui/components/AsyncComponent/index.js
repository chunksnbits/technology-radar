...
var AsyncComponent = /** @class */ (function (_super) {
    ...
    AsyncComponent.prototype.render = function () {
        if (Boolean(this.state.promise)) {
            ...
            return (React.createElement("div", { className: dom_1.classNames.apply(void 0, ['c-async-settings-panel', this.props.className].concat(modifiers)) }, this.props.children));
        }
