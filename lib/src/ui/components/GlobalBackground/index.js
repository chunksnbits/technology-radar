...
// ----------------------------------------------------------------------------- Configuration
var ANCHOR_ID = 'g-global-background';
var GlobalBackgroundRoot = /** @class */ (function (_super) {
    ...
    GlobalBackgroundRoot.prototype.render = function () {
        ...
        return (React.createElement("div", { id: ANCHOR_ID, className: classes.globalBackgroundAnchor }));
    };
...
var GlobalBackground = /** @class */ (function (_super) {
    ...
    GlobalBackground.prototype.render = function () {
        ...
        var container = document.querySelector("technology-radar::shadow #" + ANCHOR_ID);
        if (container === null) {
