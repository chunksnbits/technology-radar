...
var TechnologyList = /** @class */ (function (_super) {
    ...
    TechnologyList.prototype.render = function () {
        var _this = this;
        var _a = this.props, activeBreakpoint = _a.activeBreakpoint, focusedTechnology = _a.focusedTechnology, selectedGroup = _a.selectedGroup, selectedTechnology = _a.selectedTechnology, viewMode = _a.viewMode, technologies = _a.technologies, groups = _a.groups, classes = _a.classes;
        var active = Boolean(selectedGroup) || Boolean(selectedTechnology);
        var listView = viewMode === 'list';
        var modifiers = [
            !listView && classes.technologyListHidden,
            active && classes.technologyListHidden,
        ];
        var focusable = activeBreakpoint !== 'small' && !active && listView;
