...
export var styles = function (theme) { return ({
    root: __assign({}, layoutWide({
        ...
        maxWidth: '600px',
    }), transitionDefault('transform'), { display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', position: 'relative', width: '100%', padding: '85px 5px 70px', WebkitOverflowScrolling: 'touch', background: theme.base }),
    technologyListItems: {
        height: '100%',
        overflow: 'auto',
    },
