...
export var styles = function (theme) { return ({
    ...
    technologyDetailsLogo: __assign({}, animationDefault('logo-appear', { delay: '0.1s' }), { position: 'absolute', zIndex: -1, top: 0, left: 0, width: '100%', height: '100%', transform: 'scale(1.25) rotateZ(-3deg) translateY(5%)', pointerEvents: 'none' }),
