...
var LegendLevels = /** @class */ (function (_super) {
    ...
    LegendLevels.prototype.render = function () {
        var _a = this.props, innerRadiusPercent = _a.innerRadiusPercent, outerRadiusPercent = _a.outerRadiusPercent, technologies = _a.technologies, levels = _a.levels, classes = _a.classes;
        var modifiers = [];
