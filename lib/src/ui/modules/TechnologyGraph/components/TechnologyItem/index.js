...
import { Ripple, GroupIndicator } from '../../../../components';
...
var TechnologyItem = /** @class */ (function (_super) {
    ...
    TechnologyItem.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classNames.apply(void 0, [classes.root, className].concat(modifiers)), style: this.calculateTransforms(this.props), "custom-attribute": [technology.name, selected].join(', ') },
